...
const NAV_ICONS = {
    ...
    search: <svg className={iconClasses} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" /></svg>,
    ...
    database: <svg className={iconClasses} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 7v10c0 2.21 3.582 4 8 4s8-1.79 8-4V7M4 7c0 2.21 3.582 4 8 4s8-1.79 8-4M4 7c0-2.21 3.582-4 8-4s8 1.79 8 4m0 5c0 2.21-3.582 4-8 4s-8-1.79-8-4" /></svg>,
...
const NAV_ITEMS_STRUCTURE = {
    [UserRole.ADMIN]: [
        ...
        { id: 'search', labelKey: 'sidebar.searchEngine', icon: NAV_ICONS.search },
        ...
        { id: 'database', labelKey: 'sidebar.studentDatabase', icon: NAV_ICONS.database },
...
const Sidebar: React.FC<SidebarProps> = ({ userRole, activePage, setActivePage }) => {
    ...
    return (
        <aside className="w-64 bg-white dark:bg-gray-800 border-r dark:border-gray-700 flex-shrink-0 p-4 overflow-y-auto">
            <nav>
                <ul>
                    {navItems.map(item => (
                        <li key={item.id}>
                            <button
                                ...
                                className={`w-full text-left px-4 py-2.5 my-1 rounded-md text-sm font-medium transition-colors flex items-center
                                    ${activePage === item.id 
